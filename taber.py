...
treeDB = {
            ...
            'mshow': None,
            'new': None,
            'rcopy': { 'ANYCELLRANGE': { 'ANYCELLRANGE|ANYCELLADDR': None } },
            'rcopyasis': { 'ANYCELLRANGE': { 'ANYCELLRANGE|ANYCELLADDR': None } },
            'rclear': None,
            'rclearerr': None,
            'rgennums': { 'ANYCELLRANGE': { 'ANYNUM_[Start]': { 'ANYNUM_[Delta]': None } } },
            'xrecalc': None,
            'xrows': { 'ANYNUM': None },
            'xcols': { 'ANYNUM': None },
            'xviewraw': None,
